...
public interface GraphADT<T> { 
	 ...
	 * 
	 * @param sourceVertex the data item contained in the source vertex for the edge
	 * @param targetVertex the data item contained in the target vertex for the edge
	 ...
	 */
	public boolean insertEdge(T sourceVertex, T targetVertex, int weight);
	 ...
	 * @throws NullPointerException if either sourceVertex or targetVertex or both are null
	 */
	public boolean removeEdge(T sourceVertex, T targetVertex);
	 ...
	 */
	public int getWeight(T sourceVertex, T targetVertex);
	
	/**
	 * Returns the shortest path between startingVertex and destinationVertex.
	 * Uses Dijkstra's shortest path algorithm to find the shortest path.
	 * 
	 * @param startingVertex the data item in the starting vertex for the path
	 * @param destinationVertex the data item in the destination vertex for the path
	 ...
	 */
	public List<T> shortestPath(T startingVertex, T destinationVertex);
	 ...
	 */
	public int getPathCost(T startingVertex, T destinationVertex);
