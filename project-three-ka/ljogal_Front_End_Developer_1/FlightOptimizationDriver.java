...
/**
 * A Driver class that lets a user add and remove flights and airports as wells
...
public class FlightOptimizationDriver {
	...
	public static void main(String[] args) {
		System.out.println(
				"Hello! Welcome to fly KA. Would you like to see flights today and or remove flights? (y or n)");
		...
		case "Y":
			...
			while (check) {
				try {
					...
					String file = scnr.nextLine().trim();
